...
class DisplayBalance(Display):
    ...
    def generateComponents(self):
        self.top_text = Text(self.window, text="Bitte Karte auflegen", align="top", size=self.CONST_FONT_SIZE_GENERAL)
        self.top_text.text_color = "white"
        
        self.statistics_box = Box(self.window, width="fill", align="top", layout="grid")

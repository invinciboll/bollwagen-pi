...
buttons.append(button(0, 'effect', [0, 0], 40))
buttons.append(button(1, 'ambient', [1, 0], 38))
buttons.append(button(2, 'vent', [2, 0], 36))
...
for button in buttons:
    ...
    pushButtons.append(PushButton(app, args=[button.index], command=general_callback,
